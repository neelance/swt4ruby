...
module Org::Eclipse::Swt::Internal::Mozilla
  ...
  class NsIWindowWatcher < NsIWindowWatcherImports.const_get :NsISupports
    ...
    typesig { [::Java::Int, Array.typed(::Java::Byte), Array.typed(::Java::Byte), Array.typed(::Java::Byte), ::Java::Int, Array.typed(::Java::Int)] }
    # long
    # long
    # long
    ...
    typesig { [Array.typed(::Java::Char), ::Java::Int, Array.typed(::Java::Int)] }
    # long
    # long
