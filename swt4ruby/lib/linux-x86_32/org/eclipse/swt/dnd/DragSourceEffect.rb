...
module Org::Eclipse::Swt::Dnd
  module DragSourceEffectImports #:nodoc:
  ...
  # 
  # @since 3.3
  class DragSourceEffect < DragSourceEffectImports.const_get :DragSourceAdapter
    include_class_members DragSourceEffectImports
    ...
    private
    alias_method :initialize__drag_source_effect, :initialize
  end
