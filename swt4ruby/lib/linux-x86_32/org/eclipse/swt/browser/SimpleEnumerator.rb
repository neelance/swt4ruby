...
module Org::Eclipse::Swt::Browser
  module SimpleEnumeratorImports #:nodoc:
  ...
  class SimpleEnumerator 
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_simple_enumerator_3(ppv_object, Array.typed(::Java::Int).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsISimpleEnumerator::NS_ISIMPLEENUMERATOR_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_simple_enumerator_5(ppv_object, Array.typed(::Java::Int).new([@simple_enumerator.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # long
      XPCOM.memmove___org_eclipse_swt_browser_simple_enumerator_7(ppv_object, Array.typed(::Java::Int).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def _get_next(_retval)
      ...
      value._add_ref
      # long
      XPCOM.memmove___org_eclipse_swt_browser_simple_enumerator_11(_retval, Array.typed(::Java::Int).new([value.get_address]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
