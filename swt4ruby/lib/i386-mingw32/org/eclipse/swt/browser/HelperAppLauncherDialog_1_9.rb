  ...
  class HelperAppLauncherDialog_1_9 
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_1_9_3(ppv_object, Array.typed(::Java::Int).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIHelperAppLauncherDialog_1_9::NS_IHELPERAPPLAUNCHERDIALOG_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_1_9_5(ppv_object, Array.typed(::Java::Int).new([@helper_app_launcher_dialog.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # long
      XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_1_9_7(ppv_object, Array.typed(::Java::Int).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
