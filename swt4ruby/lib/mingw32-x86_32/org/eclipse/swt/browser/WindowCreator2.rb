...
module Org::Eclipse::Swt::Browser
  module WindowCreator2Imports #:nodoc:
  ...
  class WindowCreator2 
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_window_creator2_3(ppv_object, Array.typed(::Java::Int).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWindowCreator::NS_IWINDOWCREATOR_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_window_creator2_5(ppv_object, Array.typed(::Java::Int).new([@window_creator.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWindowCreator2::NS_IWINDOWCREATOR2_IID))
        # long
        XPCOM.memmove___org_eclipse_swt_browser_window_creator2_7(ppv_object, Array.typed(::Java::Int).new([@window_creator2.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # long
      XPCOM.memmove___org_eclipse_swt_browser_window_creator2_9(ppv_object, Array.typed(::Java::Int).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def _create_chrome_window2(parent, chrome_flags, context_flags, uri, cancel, _retval)
      ...
      if (!(parent).equal?(0))
        ...
        # long
        # long
        a_web_browser = Array.typed(::Java::Int).new(1) { 0 }
        ...
        # long
        # long
        a_parent_native_window = Array.typed(::Java::Int).new(1) { 0 }
      ...
      if (doit)
        ...
        # long
        XPCOM.memmove___org_eclipse_swt_browser_window_creator2_13(_retval, Array.typed(::Java::Int).new([chrome_ptr]), C::PTR_SIZEOF)
      else
        if (!(cancel).equal?(0))
