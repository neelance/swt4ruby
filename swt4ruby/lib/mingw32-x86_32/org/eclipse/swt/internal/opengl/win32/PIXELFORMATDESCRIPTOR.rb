...
module Org::Eclipse::Swt::Internal::Opengl::Win32
  module PIXELFORMATDESCRIPTORImports #:nodoc:
  ...
  class PIXELFORMATDESCRIPTOR 
    include_class_members PIXELFORMATDESCRIPTORImports
    ...
    attr_accessor :i_layer_type
    alias_method :attr_i_layer_type, :i_layer_type
    undef_method :i_layer_type
    alias_method :attr_i_layer_type=, :i_layer_type=
    undef_method :i_layer_type=
    ...
    attr_accessor :dw_layer_mask
    alias_method :attr_dw_layer_mask, :dw_layer_mask
    undef_method :dw_layer_mask
    alias_method :attr_dw_layer_mask=, :dw_layer_mask=
    undef_method :dw_layer_mask=
    
    attr_accessor :dw_visible_mask
    alias_method :attr_dw_visible_mask, :dw_visible_mask
    undef_method :dw_visible_mask
    alias_method :attr_dw_visible_mask=, :dw_visible_mask=
    undef_method :dw_visible_mask=
    
    attr_accessor :dw_damage_mask
    alias_method :attr_dw_damage_mask, :dw_damage_mask
    undef_method :dw_damage_mask
    alias_method :attr_dw_damage_mask=, :dw_damage_mask=
    undef_method :dw_damage_mask=
    ...
    private
    alias_method :initialize__pixelformatdescriptor, :initialize
  end
