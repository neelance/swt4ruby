...
module Org::Eclipse::Swt::Internal::Opengl::Win32
  ...
  class WGL < WGLImports.const_get :Platform
    ...
    class_module.module_eval {
      ...
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_ChoosePixelFormat, [:pointer, :long, :int32, :long], :int32
      typesig { [::Java::Int, PIXELFORMATDESCRIPTOR] }
      # @param hdc cast=(HDC)
      # long
      def _choose_pixel_format(hdc, ppfd)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_ChoosePixelFormat, JNI.env, self.jni_id, hdc.to_int, ppfd.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_DescribePixelFormat, [:pointer, :long, :int32, :int32, :int32, :long], :int32
      typesig { [::Java::Int, ::Java::Int, ::Java::Int, PIXELFORMATDESCRIPTOR] }
      # @param hdc cast=(HDC)
      # long
      def _describe_pixel_format(hdc, i_pixel_format, n_bytes, ppfd)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_DescribePixelFormat, JNI.env, self.jni_id, hdc.to_int, i_pixel_format.to_int, n_bytes.to_int, ppfd.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_GetPixelFormat, [:pointer, :long, :int32], :int32
      typesig { [::Java::Int] }
      # @param hdc cast=(HDC)
      # long
      def _get_pixel_format(hdc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_GetPixelFormat, JNI.env, self.jni_id, hdc.to_int)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_SetPixelFormat, [:pointer, :long, :int32, :int32, :long], :int8
      typesig { [::Java::Int, ::Java::Int, PIXELFORMATDESCRIPTOR] }
      # @param hdc cast=(HDC)
      # long
      def _set_pixel_format(hdc, i_pixel_format, ppfd)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_SetPixelFormat, JNI.env, self.jni_id, hdc.to_int, i_pixel_format.to_int, ppfd.jni_id) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_SwapBuffers, [:pointer, :long, :int32], :int8
      typesig { [::Java::Int] }
      # @param hdc cast=(HDC)
      # long
      def _swap_buffers(hdc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_SwapBuffers, JNI.env, self.jni_id, hdc.to_int) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCopyContext, [:pointer, :long, :int32, :int32, :int32], :int8
      ...
      def wgl_copy_context(hglrc_src, hglrc_dst, mask)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCopyContext, JNI.env, self.jni_id, hglrc_src.to_int, hglrc_dst.to_int, mask.to_int) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCreateContext, [:pointer, :long, :int32], :int32
      typesig { [::Java::Int] }
      # @param hdc cast=(HDC)
      # long
      # long
      def wgl_create_context(hdc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCreateContext, JNI.env, self.jni_id, hdc.to_int)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCreateLayerContext, [:pointer, :long, :int32, :int32], :int32
      typesig { [::Java::Int, ::Java::Int] }
      # @param hdc cast=(HDC)
      # long
      # long
      def wgl_create_layer_context(hdc, i_layer_plane)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglCreateLayerContext, JNI.env, self.jni_id, hdc.to_int, i_layer_plane.to_int)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglDeleteContext, [:pointer, :long, :int32], :int8
      typesig { [::Java::Int] }
      # @param hglrc cast=(HGLRC)
      # long
      def wgl_delete_context(hglrc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglDeleteContext, JNI.env, self.jni_id, hglrc.to_int) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetCurrentContext, [:pointer, :long], :int32
      typesig { [] }
      # long
      def wgl_get_current_context
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetCurrentContext, JNI.env, self.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetCurrentDC, [:pointer, :long], :int32
      typesig { [] }
      # long
      def wgl_get_current_dc
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetCurrentDC, JNI.env, self.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetProcAddress, [:pointer, :long, :long], :int32
      typesig { [Array.typed(::Java::Byte)] }
      # long
      def wgl_get_proc_address(lpsz_proc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetProcAddress, JNI.env, self.jni_id, lpsz_proc.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglMakeCurrent, [:pointer, :long, :int32, :int32], :int8
      typesig { [::Java::Int, ::Java::Int] }
      # @param hdc cast=(HDC)
      # @param hglrc cast=(HGLRC)
      # 
      ...
      def wgl_make_current(hdc, hglrc)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglMakeCurrent, JNI.env, self.jni_id, hdc.to_int, hglrc.to_int) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglShareLists, [:pointer, :long, :int32, :int32], :int8
      typesig { [::Java::Int, ::Java::Int] }
      ...
      def wgl_share_lists(hglrc1, hglrc2)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglShareLists, JNI.env, self.jni_id, hglrc1.to_int, hglrc2.to_int) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglDescribeLayerPlane, [:pointer, :long, :int32, :int32, :int32, :int32, :long], :int8
      ...
      def wgl_describe_layer_plane(hdc, i_pixel_format, i_layer_plane, n_bytes, plpd)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglDescribeLayerPlane, JNI.env, self.jni_id, hdc.to_int, i_pixel_format.to_int, i_layer_plane.to_int, n_bytes.to_int, plpd.jni_id) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglSetLayerPaletteEntries, [:pointer, :long, :int32, :int32, :int32, :int32, :long], :int32
      ...
      def wgl_set_layer_palette_entries(hdc, i_layer_plane, i_start, c_entries, pcr)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglSetLayerPaletteEntries, JNI.env, self.jni_id, hdc.to_int, i_layer_plane.to_int, i_start.to_int, c_entries.to_int, pcr.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetLayerPaletteEntries, [:pointer, :long, :int32, :int32, :int32, :int32, :long], :int32
      typesig { [::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, Array.typed(::Java::Int)] }
      # @param hdc cast=(HDC)
      # @param pcr cast=(COLORREF *)
      # 
      ...
      def wgl_get_layer_palette_entries(hdc, i_layer_plane, i_start, c_entries, pcr)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglGetLayerPaletteEntries, JNI.env, self.jni_id, hdc.to_int, i_layer_plane.to_int, i_start.to_int, c_entries.to_int, pcr.jni_id)
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglRealizeLayerPalette, [:pointer, :long, :int32, :int32, :int8], :int8
      typesig { [::Java::Int, ::Java::Int, ::Java::Boolean] }
      # @param hdc cast=(HDC)
      # long
      def wgl_realize_layer_palette(hdc, i_layer_plane, b_realize)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglRealizeLayerPalette, JNI.env, self.jni_id, hdc.to_int, i_layer_plane.to_int, b_realize ? 1 : 0) != 0
      end
      
      JNI.load_native_method :Java_org_eclipse_swt_internal_opengl_win32_WGL_wglSwapLayerBuffers, [:pointer, :long, :int32, :int32], :int8
      typesig { [::Java::Int, ::Java::Int] }
      # @param hdc cast=(HDC)
      # long
      def wgl_swap_layer_buffers(hdc, fu_planes)
        JNI.call_native_method(:Java_org_eclipse_swt_internal_opengl_win32_WGL_wglSwapLayerBuffers, JNI.env, self.jni_id, hdc.to_int, fu_planes.to_int) != 0
      end
    }
