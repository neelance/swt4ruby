...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIComponentManagerImports #:nodoc:
  ...
  class NsIComponentManager < NsIComponentManagerImports.const_get :NsISupports
    ...
    typesig { [NsID, ::Java::Int, NsID, Array.typed(::Java::Int)] }
    # long
    # long
    ...
    typesig { [Array.typed(::Java::Byte), ::Java::Int, NsID, Array.typed(::Java::Int)] }
    # long
    # long
