...
module Org::Eclipse::Swt::Internal::Win32
  module NONCLIENTMETRICSAImports #:nodoc:
  ...
  class NONCLIENTMETRICSA < NONCLIENTMETRICSAImports.const_get :NONCLIENTMETRICS
    include_class_members NONCLIENTMETRICSAImports
    ...
    class_module.module_eval {
      const_set_lazy(:Sizeof) { OS._nonclientmetricsa_sizeof }
    ...
    def initialize
      ...
      @lf_message_font = nil
      super()
      @lf_caption_font = LOGFONTA.new
      @lf_sm_caption_font = LOGFONTA.new
      @lf_menu_font = LOGFONTA.new
      @lf_status_font = LOGFONTA.new
      @lf_message_font = LOGFONTA.new
    end
    
    private
    alias_method :initialize__nonclientmetricsa, :initialize
  end
