...
module Org::Eclipse::Swt::Internal::Win32
  module TEXTMETRICAImports #:nodoc:
  ...
  class TEXTMETRICA < TEXTMETRICAImports.const_get :TEXTMETRIC
    include_class_members TEXTMETRICAImports
    ...
    class_module.module_eval {
      const_set_lazy(:Sizeof) { OS._textmetrica_sizeof }
    ...
    private
    alias_method :initialize__textmetrica, :initialize
  end
