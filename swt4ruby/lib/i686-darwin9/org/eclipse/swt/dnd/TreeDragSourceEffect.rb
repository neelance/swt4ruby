...
module Org::Eclipse::Swt::Dnd
  ...
  class TreeDragSourceEffect < TreeDragSourceEffectImports.const_get :DragSourceEffect
    ...
    def get_drag_source_image(event)
      ...
      OS.memmove___org_eclipse_swt_dnd_tree_drag_source_effect_1(ptr, point, NSPoint.attr_sizeof)
      ...
      OS.memmove___org_eclipse_swt_dnd_tree_drag_source_effect_3(point, ptr, NSPoint.attr_sizeof)
      OS.free(ptr)
