  ...
  class Program 
    ...
    class_module.module_eval {
      ...
      def get_desktop(display)
        ...
        # int
        # int
        property = Array.typed(::Java::Long).new(num_prop[0]) { 0 }
    ...
    class_module.module_eval {
      ...
      def cde_get_data_type_info
        ...
        if (!(data_type_list).equal?(0))
          ...
          # int
          # int
          data_type = Array.typed(::Java::Long).new(1) { 0 }
    ...
    class_module.module_eval {
      ...
      def cde_init(display)
        ...
        # int
        # int
        argc = Array.typed(::Java::Long).new([0])
    ...
    class_module.module_eval {
      ...
      def gnome_get_mime_info
        ...
        # int
        # int
        mime_data = Array.typed(::Java::Long).new(1) { 0 }
        # int
        # int
        extension_data = Array.typed(::Java::Long).new(1) { 0 }
        # int
