...
module Org::Eclipse::Swt::Accessibility
  module AccessibleAdapterImports #:nodoc:
  ...
  class AccessibleAdapter 
    include_class_members AccessibleAdapterImports
    include AccessibleListener
    ...
    private
    alias_method :initialize__accessible_adapter, :initialize
  end
