...
module Org::Eclipse::Swt::Browser
  module HelperAppLauncherDialogFactoryImports #:nodoc:
  ...
  class HelperAppLauncherDialogFactory 
    include_class_members HelperAppLauncherDialogFactoryImports
    ...
    def create_cominterfaces
      ...
      Class.new(XPCOMObject.class == Class ? XPCOMObject : Object) do
        local_class_in HelperAppLauncherDialogFactory
        include_class_members HelperAppLauncherDialogFactory
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_factory_3(ppv_object, Array.typed(::Java::Long).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIFactory::NS_IFACTORY_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_factory_5(ppv_object, Array.typed(::Java::Long).new([@factory.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
      XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_factory_7(ppv_object, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def _create_instance(a_outer, iid, result)
      if (Mozilla::IsPre_1_9)
        ...
        # int
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_factory_9(result, Array.typed(::Java::Long).new([helper_app_launcher_dialog.get_address]), C::PTR_SIZEOF)
      else
        helper_app_launcher_dialog = HelperAppLauncherDialog_1_9.new
        helper_app_launcher_dialog._add_ref
        # int
        XPCOM.memmove___org_eclipse_swt_browser_helper_app_launcher_dialog_factory_11(result, Array.typed(::Java::Long).new([helper_app_launcher_dialog.get_address]), C::PTR_SIZEOF)
      end
      return XPCOM::NS_OK
    end
    ...
    private
    alias_method :initialize__helper_app_launcher_dialog_factory, :initialize
  end
