...
module Org::Eclipse::Swt::Browser
  module AppFileLocProviderImports #:nodoc:
  ...
  class AppFileLocProvider 
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_3(ppv_object, Array.typed(::Java::Long).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIDirectoryServiceProvider::NS_IDIRECTORYSERVICEPROVIDER_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_5(ppv_object, Array.typed(::Java::Long).new([@directory_service_provider.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIDirectoryServiceProvider2::NS_IDIRECTORYSERVICEPROVIDER2_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_7(ppv_object, Array.typed(::Java::Long).new([@directory_service_provider2.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
      XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_9(ppv_object, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def get_files(prop, _retval)
      ...
      # int
      XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_15(_retval, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      if (!(property_values).nil?)
        ...
        enumerator._add_ref
        # int
        XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_17(_retval, Array.typed(::Java::Long).new([enumerator.get_address]), C::PTR_SIZEOF)
        return XPCOM::NS_OK
      end
    ...
    def get_file(prop, persistent, _retval)
      ...
      # PRBool
      # int
      XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_23(_retval, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      if (!(property_value).nil? && property_value.length > 0)
        ...
        # int
        XPCOM.memmove___org_eclipse_swt_browser_app_file_loc_provider_25(_retval, Array.typed(::Java::Long).new([result[0]]), C::PTR_SIZEOF)
        local_file._release
        return XPCOM::NS_OK
      end
      return XPCOM::NS_ERROR_FAILURE
