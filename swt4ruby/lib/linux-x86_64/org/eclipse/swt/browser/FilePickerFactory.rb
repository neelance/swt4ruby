...
module Org::Eclipse::Swt::Browser
  module FilePickerFactoryImports #:nodoc:
  ...
  class FilePickerFactory 
    include_class_members FilePickerFactoryImports
    ...
    def create_cominterfaces
      ...
      Class.new(XPCOMObject.class == Class ? XPCOMObject : Object) do
        local_class_in FilePickerFactory
        include_class_members FilePickerFactory
    ...
    def _query_interface(riid, ppv_object)
      ...
      guid = NsID.new
      XPCOM.memmove___org_eclipse_swt_browser_file_picker_factory_1(guid, riid, self.attr_ns_id.attr_sizeof)
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_file_picker_factory_3(ppv_object, Array.typed(::Java::Long).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIFactory::NS_IFACTORY_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_file_picker_factory_5(ppv_object, Array.typed(::Java::Long).new([@factory.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
      XPCOM.memmove___org_eclipse_swt_browser_file_picker_factory_7(ppv_object, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def _create_instance(a_outer, iid, result)
      ...
      picker._add_ref
      # int
      XPCOM.memmove___org_eclipse_swt_browser_file_picker_factory_9(result, Array.typed(::Java::Long).new([picker.get_address]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    private
    alias_method :initialize__file_picker_factory, :initialize
  end
