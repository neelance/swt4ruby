  ...
  class Mozilla < MozillaImports.const_get :WebBrowser
      ...
      if (!self.attr_initialized)
        ...
        if (!self.attr_initialized)
          ...
          if (is_xulrunner)
            ...
            # int
            C.memmove___org_eclipse_swt_browser_mozilla_17(function_load.attr_function, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
            ...
            C.free(ptr)
            rc = XPCOM._call___org_eclipse_swt_browser_mozilla_23(function_ptr, local_file.get_address, local_file.get_address, self.attr_location_provider.get_address, 0, 0)
            if ((rc).equal?(XPCOM::NS_OK))
        ...
        if (!(self.attr_location_provider).nil?)
          ...
          buffer = Array.typed(::Java::Byte).new(length_) { 0 }
          XPCOM.memmove___org_eclipse_swt_browser_mozilla_25(buffer, ptr, length_)
        ...
        if (!(rc).equal?(XPCOM::NS_OK))
          ...
          length_ = XPCOM.strlen__prunichar(result[0])
          dest = CharArray.new(length_)
          XPCOM.memmove___org_eclipse_swt_browser_mozilla_29(dest, result[0], length_ * 2)
      ...
      if ((display.get_data(DISPOSE_LISTENER_HOOKED)).nil?)
        ...
        display.add_listener(SWT::Dispose, Class.new(Listener.class == Class ? Listener : Object) do
          ...
          define_method :handle_event do |event|
            ...
            # int
            # int
            result_ = Array.typed(::Java::Long).new(1) { 0 }
    ...
    def get_text
      ...
      if ((rc).equal?(XPCOM::NS_OK))
        ...
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_31(chars, buffer, length_ * 2)
        ...
        length_ = XPCOM.strlen__prunichar(result[0])
        chars = CharArray.new(length_)
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_33(chars, result[0], length_ * 2)
      end
      component_manager._release
    ...
    def get_url
      ...
      # int
      # int
      a_current_uri = Array.typed(::Java::Long).new(1) { 0 }
      ...
      if (!(a_current_uri[0]).equal?(0))
        ...
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_35(dest, buffer, length_)
        XPCOM.ns_embed_cstring_delete(a_spec)
        uri._release
      end
      if ((dest).nil?)
    ...
    def _query_interface(riid, ppv_object)
      ...
      guid = NsID.new
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_37(guid, riid, self.attr_ns_id.attr_sizeof)
      if (guid._equals(NsISupports::NS_ISUPPORTS_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_39(ppv_object, Array.typed(::Java::Long).new([@supports.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWeakReference::NS_IWEAKREFERENCE_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_41(ppv_object, Array.typed(::Java::Long).new([@weak_reference.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWebProgressListener::NS_IWEBPROGRESSLISTENER_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_43(ppv_object, Array.typed(::Java::Long).new([@web_progress_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWebBrowserChrome::NS_IWEBBROWSERCHROME_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_45(ppv_object, Array.typed(::Java::Long).new([@web_browser_chrome.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWebBrowserChromeFocus::NS_IWEBBROWSERCHROMEFOCUS_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_47(ppv_object, Array.typed(::Java::Long).new([@web_browser_chrome_focus.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIEmbeddingSiteWindow::NS_IEMBEDDINGSITEWINDOW_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_49(ppv_object, Array.typed(::Java::Long).new([@embedding_site_window.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIInterfaceRequestor::NS_IINTERFACEREQUESTOR_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_51(ppv_object, Array.typed(::Java::Long).new([@interface_requestor.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsISupportsWeakReference::NS_ISUPPORTSWEAKREFERENCE_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_53(ppv_object, Array.typed(::Java::Long).new([@supports_weak_reference.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIContextMenuListener::NS_ICONTEXTMENULISTENER_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_55(ppv_object, Array.typed(::Java::Long).new([@context_menu_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIURIContentListener::NS_IURICONTENTLISTENER_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_57(ppv_object, Array.typed(::Java::Long).new([@uri_content_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsITooltipListener::NS_ITOOLTIPLISTENER_IID))
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_59(ppv_object, Array.typed(::Java::Long).new([@tooltip_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_61(ppv_object, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_ERROR_NO_INTERFACE
    end
    ...
    def _get_interface(riid, ppv_object)
      ...
      guid = NsID.new
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_63(guid, riid, self.attr_ns_id.attr_sizeof)
      if (guid._equals(NsIDOMWindow::NS_IDOMWINDOW_IID))
        # int
        # int
        a_content_domwindow = Array.typed(::Java::Long).new(1) { 0 }
        ...
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_65(ppv_object, a_content_domwindow, C::PTR_SIZEOF)
        return rc
      end
      return _query_interface(riid, ppv_object)
    end
    ...
    def _get_weak_reference(ppv_object)
      # int
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_67(ppv_object, Array.typed(::Java::Long).new([@weak_reference.get_address]), C::PTR_SIZEOF)
      _add_ref
      return XPCOM::NS_OK
    end
        ...
        if (!((a_state_flags & NsIWebProgressListener::STATE_REDIRECTING)).equal?(0))
          ...
          if (!((a_state_flags & NsIWebProgressListener::STATE_STOP)).equal?(0))
            ...
            if (!(@html_bytes).nil?)
              ...
              dest = Array.typed(::Java::Byte).new(length_) { 0 }
              XPCOM.memmove___org_eclipse_swt_browser_mozilla_69(dest, buffer, length_)
              url = String.new(dest)
              XPCOM.ns_embed_cstring_delete(name)
              if (url.starts_with(ABOUT_BLANK))
                ...
                XPCOM.memmove___org_eclipse_swt_browser_mozilla_71(ptr, @html_bytes, @html_bytes.attr_length)
                page_size = 8192
    ...
    def _on_location_change(a_web_progress, a_request, a_location)
      ...
      # int
      # int
      a_domwindow = Array.typed(::Java::Long).new(1) { 0 }
      ...
      # int
      # int
      a_top = Array.typed(::Java::Long).new(1) { 0 }
      ...
      buffer = XPCOM.ns_embed_cstring_get(a_spec)
      dest = Array.typed(::Java::Byte).new(length_) { 0 }
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_73(dest, buffer, length_)
      XPCOM.ns_embed_cstring_delete(a_spec)
      url = String.new(dest)
    ...
    def _on_status_change(a_web_progress, a_request, a_status, a_message)
      ...
      dest = CharArray.new(length_)
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_75(dest, a_message, length_ * 2)
    ...
    def _set_status(status_type, status)
      ...
      dest = CharArray.new(length_)
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_77(dest, status, length_ * 2)
    ...
    def _get_web_browser(a_web_browser)
      # int
      # int
      ret = Array.typed(::Java::Long).new(1) { 0 }
      if (!(@web_browser).nil?)
        @web_browser._add_ref
        ret[0] = @web_browser.get_address
      end
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_79(a_web_browser, ret, C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    def _get_chrome_flags(a_chrome_flags)
      ...
      ret[0] = @chrome_flags
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_81(a_chrome_flags, ret, 4)
      # PRUint32
      return XPCOM::NS_OK
    end
    ...
    def _is_window_modal(retval)
      ...
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_83(retval, Array.typed(::Java::Int).new([result]), 4)
      # PRBool
      return XPCOM::NS_OK
    end
    ...
    def _get_dimensions(flags, x, y, cx, cy)
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_POSITION)).equal?(0))
        ...
        if (!(x).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_85(x, Array.typed(::Java::Int).new([location.attr_x]), 4)
        end
        # PRInt32
        if (!(y).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_87(y, Array.typed(::Java::Int).new([location.attr_y]), 4)
        end
        # PRInt32
      end
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_SIZE_INNER)).equal?(0))
        ...
        if (!(cx).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_89(cx, Array.typed(::Java::Int).new([size.attr_x]), 4)
        end
        # PRInt32
        if (!(cy).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_91(cy, Array.typed(::Java::Int).new([size.attr_y]), 4)
        end
        # PRInt32
      end
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_SIZE_OUTER)).equal?(0))
        ...
        if (!(cx).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_93(cx, Array.typed(::Java::Int).new([size.attr_x]), 4)
        end
        # PRInt32
        if (!(cy).equal?(0))
          C.memmove___org_eclipse_swt_browser_mozilla_95(cy, Array.typed(::Java::Int).new([size.attr_y]), 4)
        end
        # PRInt32
      end
      return XPCOM::NS_OK
    ...
    def _get_visibility(a_visibility)
      ...
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_97(a_visibility, Array.typed(::Java::Int).new([visible ? 1 : 0]), 4)
      # PRBool
      return XPCOM::NS_OK
    end
    ...
    def _set_title(a_title)
      ...
      if (length_ > 0)
        dest = CharArray.new(length_)
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_99(dest, a_title, length_ * 2)
    ...
    def _get_site_window(a_site_window)
      ...
      # 
      # int
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_101(a_site_window, Array.typed(::Java::Long).new([@embed_handle]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    def _on_start_uriopen(a_uri, retval)
      ...
      buffer = XPCOM.ns_embed_cstring_get(a_spec)
      dest = Array.typed(::Java::Byte).new(length_) { 0 }
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_103(dest, buffer, length_)
      XPCOM.ns_embed_cstring_delete(a_spec)
      ...
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_105(retval, Array.typed(::Java::Int).new([doit ? 0 : 1]), 4)
      # PRBool
      return XPCOM::NS_OK
    end
    
    typesig { [::Java::Long, ::Java::Int, ::Java::Long, ::Java::Long, ::Java::Long] }
    # int
    # int
    # int
    # int
    ...
    def _is_preferred(a_content_type, a_desired_content_type, retval)
      ...
      if (size > 0)
        ...
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_107(type_bytes, a_content_type, size)
      ...
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_109(retval, Array.typed(::Java::Int).new([preferred ? 1 : 0]), 4)
      # PRBool
      if (preferred)
        # int
        XPCOM.memmove___org_eclipse_swt_browser_mozilla_111(a_desired_content_type, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      end
      return XPCOM::NS_OK
    end
    ...
    def _on_show_tooltip(a_xcoords, a_ycoords, a_tip_text)
      ...
      dest = CharArray.new(length_)
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_113(dest, a_tip_text, length_ * 2)
    ...
    def _handle_event(event)
      ...
      chars = CharArray.new(length_)
      XPCOM.memmove___org_eclipse_swt_browser_mozilla_115(chars, buffer, length_ * 2)
