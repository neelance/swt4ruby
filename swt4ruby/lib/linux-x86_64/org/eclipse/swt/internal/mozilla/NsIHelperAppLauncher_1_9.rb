...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIHelperAppLauncher_1_9Imports #:nodoc:
  ...
  class NsIHelperAppLauncher_1_9 < NsIHelperAppLauncher_1_9Imports.const_get :NsICancelable
    ...
    class_module.module_eval {
      const_set_lazy(:LAST_METHOD_ID) { NsICancelable::LAST_METHOD_ID + 10 }
      const_attr_reader  :LAST_METHOD_ID
      
      const_set_lazy(:NS_IHELPERAPPLAUNCHER_IID_STR) { "cc75c21a-0a79-4f68-90e1-563253d0c555" }
    ...
    def _get_target_file_is_executable(a_target_file_is_executable)
      return XPCOM._vtbl_call(NsICancelable::LAST_METHOD_ID + 9, get_address, a_target_file_is_executable)
    end
    
    typesig { [::Java::Long] }
    # int
    def _get_time_download_started(a_time_download_started)
      return XPCOM._vtbl_call(NsICancelable::LAST_METHOD_ID + 10, get_address, a_time_download_started)
    end
    
    private
    alias_method :initialize_ns_ihelper_app_launcher_1_9, :initialize
  end
