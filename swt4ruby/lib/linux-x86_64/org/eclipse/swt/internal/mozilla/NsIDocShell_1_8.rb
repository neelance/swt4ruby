...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIDocShell_1_8Imports #:nodoc:
  ...
  class NsIDocShell_1_8 < NsIDocShell_1_8Imports.const_get :NsISupports
    ...
    class_module.module_eval {
      const_set_lazy(:LAST_METHOD_ID) { NsISupports::LAST_METHOD_ID + 61 }
      const_attr_reader  :LAST_METHOD_ID
      
      const_set_lazy(:NS_IDOCSHELL_IID_STR) { "9f0c7461-b9a4-47f6-b88c-421dce1bce66" }
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Long, ::Java::Int, Array.typed(::Java::Char), Array.typed(::Java::Byte), ::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Int, Array.typed(::Java::Long), Array.typed(::Java::Long)] }
    # int
    # int
    # int
    # int
    ...
    private
    alias_method :initialize_ns_idoc_shell_1_8, :initialize
  end
