...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIFilePickerImports #:nodoc:
  ...
  class NsIFilePicker < NsIFilePickerImports.const_get :NsISupports
    include_class_members NsIFilePickerImports
    
    class_module.module_eval {
      const_set_lazy(:LAST_METHOD_ID) { NsISupports::LAST_METHOD_ID + 15 }
      const_attr_reader  :LAST_METHOD_ID
      
      const_set_lazy(:NS_IFILEPICKER_IID_STR) { "c47de916-1dd1-11b2-8141-82507fa02b21" }
    ...
    typesig { [::Java::Long, Array.typed(::Java::Char), ::Java::Int] }
    # int
    ...
    private
    alias_method :initialize_ns_ifile_picker, :initialize
  end
