...
module Org::Eclipse::Swt::Internal::Mozilla
  ...
  class NsIPrincipal < NsIPrincipalImports.const_get :NsISerializable
    ...
    typesig { [Array.typed(::Java::Long), Array.typed(::Java::Long), Array.typed(::Java::Long), Array.typed(::Java::Long), Array.typed(::Java::Long), Array.typed(::Java::Int)] }
    # int
    # int
    # int
    # int
    ...
    typesig { [Array.typed(::Java::Byte), ::Java::Long, Array.typed(::Java::Int)] }
    # int
