...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIDocShellImports #:nodoc:
  ...
  class NsIDocShell < NsIDocShellImports.const_get :NsISupports
    include_class_members NsIDocShellImports
    
    class_module.module_eval {
      const_set_lazy(:LAST_METHOD_ID) { NsISupports::LAST_METHOD_ID + 51 }
      const_attr_reader  :LAST_METHOD_ID
      
      const_set_lazy(:NS_IDOCSHELL_IID_STR) { "69e5de00-7b8b-11d3-af61-00a024ffc08c" }
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Long, ::Java::Int, Array.typed(::Java::Char), ::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Int, Array.typed(::Java::Long), Array.typed(::Java::Long)] }
    # int
    # int
    # int
    # int
    ...
    # int
    # int
    def _internal_load(a_uri, a_referrer, a_owner, a_inherit_owner, a_window_target, a_post_data_stream, a_headers_stream, a_load_flags, a_shentry, first_party, a_doc_shell, a_request)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 3, get_address, a_uri, a_referrer, a_owner, a_inherit_owner, a_window_target, a_post_data_stream, a_headers_stream, a_load_flags, a_shentry, first_party, a_doc_shell, a_request)
    end
    ...
    typesig { [] }
    def _fire_unload_notification
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 7, get_address)
    end
    ...
    def _get_parent_uricontent_listener(a_parent_uricontent_listener)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 14, get_address, a_parent_uricontent_listener)
    end
    
    typesig { [::Java::Long] }
    # int
    def _set_parent_uricontent_listener(a_parent_uricontent_listener)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 15, get_address, a_parent_uricontent_listener)
    end
    
    typesig { [Array.typed(::Java::Long)] }
    # int
    def _get_document_charset_info(a_document_charset_info)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 16, get_address, a_document_charset_info)
    end
    
    typesig { [::Java::Long] }
    # int
    def _set_document_charset_info(a_document_charset_info)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 17, get_address, a_document_charset_info)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_plugins(a_allow_plugins)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 18, get_address, a_allow_plugins)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_plugins(a_allow_plugins)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 19, get_address, a_allow_plugins)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_javascript(a_allow_javascript)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 20, get_address, a_allow_javascript)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_javascript(a_allow_javascript)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 21, get_address, a_allow_javascript)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_meta_redirects(a_allow_meta_redirects)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 22, get_address, a_allow_meta_redirects)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_meta_redirects(a_allow_meta_redirects)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 23, get_address, a_allow_meta_redirects)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_subframes(a_allow_subframes)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 24, get_address, a_allow_subframes)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_subframes(a_allow_subframes)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 25, get_address, a_allow_subframes)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_images(a_allow_images)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 26, get_address, a_allow_images)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_images(a_allow_images)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 27, get_address, a_allow_images)
    end
    ...
    def _get_doc_shell_enumerator(a_item_type, a_direction, _retval)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 28, get_address, a_item_type, a_direction, _retval)
    end
    ...
    def _get_app_type(a_app_type)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 29, get_address, a_app_type)
    end
    
    typesig { [::Java::Int] }
    def _set_app_type(a_app_type)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 30, get_address, a_app_type)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_allow_auth(a_allow_auth)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 31, get_address, a_allow_auth)
    end
    
    typesig { [::Java::Int] }
    def _set_allow_auth(a_allow_auth)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 32, get_address, a_allow_auth)
    end
    
    typesig { [Array.typed(::Java::Float)] }
    def _get_zoom(a_zoom)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 33, get_address, a_zoom)
    end
    
    typesig { [::Java::Float] }
    def _set_zoom(a_zoom)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 34, get_address, a_zoom)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_margin_width(a_margin_width)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 35, get_address, a_margin_width)
    end
    
    typesig { [::Java::Int] }
    def _set_margin_width(a_margin_width)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 36, get_address, a_margin_width)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_margin_height(a_margin_height)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 37, get_address, a_margin_height)
    end
    
    typesig { [::Java::Int] }
    def _set_margin_height(a_margin_height)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 38, get_address, a_margin_height)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_has_focus(a_has_focus)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 39, get_address, a_has_focus)
    end
    
    typesig { [::Java::Int] }
    def _set_has_focus(a_has_focus)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 40, get_address, a_has_focus)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_canvas_has_focus(a_canvas_has_focus)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 41, get_address, a_canvas_has_focus)
    end
    
    typesig { [::Java::Int] }
    def _set_canvas_has_focus(a_canvas_has_focus)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 42, get_address, a_canvas_has_focus)
    end
    
    typesig { [::Java::Int, Array.typed(::Java::Int)] }
    def _tab_to_tree_owner(forward, took_focus)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 43, get_address, forward, took_focus)
    end
    ...
    def _get_busy_flags(a_busy_flags)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 44, get_address, a_busy_flags)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_load_type(a_load_type)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 45, get_address, a_load_type)
    end
    
    typesig { [::Java::Int] }
    def _set_load_type(a_load_type)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 46, get_address, a_load_type)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _is_being_destroyed(_retval)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 47, get_address, _retval)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_is_executing_on_load_handler(a_is_executing_on_load_handler)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 48, get_address, a_is_executing_on_load_handler)
    end
    
    typesig { [Array.typed(::Java::Long)] }
    # int
    def _get_layout_history_state(a_layout_history_state)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 49, get_address, a_layout_history_state)
    end
    
    typesig { [::Java::Long] }
    # int
    def _set_layout_history_state(a_layout_history_state)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 50, get_address, a_layout_history_state)
    end
    
    typesig { [Array.typed(::Java::Int)] }
    def _get_should_save_layout_state(a_should_save_layout_state)
      return XPCOM._vtbl_call(NsISupports::LAST_METHOD_ID + 51, get_address, a_should_save_layout_state)
    end
    
    private
    alias_method :initialize_ns_idoc_shell, :initialize
  end
