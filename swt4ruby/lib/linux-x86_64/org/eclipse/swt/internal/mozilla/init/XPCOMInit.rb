...
module Org::Eclipse::Swt::Internal::Mozilla::Init
  ...
  class XPCOMInit < XPCOMInitImports.const_get :Platform
    ...
    class_module.module_eval {
      ...
      JNI.native_method :Java_org_eclipse_swt_internal_mozilla_init_XPCOMInit__1GRE_1GetGREPathWithProperties, [:pointer, :long, :long, :int32, :int64, :int32, :int64, :int32], :int32
