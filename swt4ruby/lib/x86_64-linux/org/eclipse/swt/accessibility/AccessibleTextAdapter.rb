...
module Org::Eclipse::Swt::Accessibility
  module AccessibleTextAdapterImports #:nodoc:
  ...
  class AccessibleTextAdapter 
    include_class_members AccessibleTextAdapterImports
    include AccessibleTextListener
    ...
    private
    alias_method :initialize__accessible_text_adapter, :initialize
  end
