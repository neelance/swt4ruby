...
module Org::Eclipse::Swt::Accessibility
  ...
  class AccessibleObject 
    ...
    typesig { [::Java::Long, ::Java::Long, Accessible, ::Java::Long, ::Java::Boolean] }
    # int
    # int
    # int
    ...
    class_module.module_eval {
      ...
      def atk_action_get_keybinding(atk_object, index)
        ...
        if (!(parent_result).equal?(0))
          ...
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_3(buffer, parent_result, length)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_5(self.attr_keybinding_ptr, name, name.attr_length)
      ...
      def atk_action_get_name(atk_object, index)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_ACTION_TYPE))
          ...
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_action_get_iface(object.attr_handle))
          action_iface = AtkActionIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_7(action_iface, super_type)
        ...
        if (!(parent_result).equal?(0))
          length = OS.strlen(parent_result)
          buffer = Array.typed(::Java::Byte).new(length) { 0 }
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_9(buffer, parent_result, length)
          event.attr_result = String.new(Converter.mbcs_to_wcs(nil, buffer))
        end
        i = 0
        while i < listeners.attr_length
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_11(self.attr_action_name_ptr, name, name.attr_length)
      ...
      def atk_component_get_extents(atk_object, x, y, width, height, coord_type)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_13(x, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_15(y, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_17(width, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_19(height, Array.typed(::Java::Int).new([0]), 4)
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_COMPONENT_TYPE))
          ...
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_21(component_iface, super_type)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_23(parent_x, x, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_25(parent_y, y, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_27(parent_width, width, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_29(parent_height, height, 4)
        event = AccessibleControlEvent.new(object.attr_accessible)
        event.attr_child_id = object.attr_id
        ...
        if ((coord_type).equal?(ATK::ATK_XY_WINDOW))
          ...
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_31(gtk_accessible, gtk_accessible_handle)
          # int
        ...
        if ((coord_type).equal?(ATK::ATK_XY_WINDOW))
          ...
          gtk_accessible_handle = ATK._gtk_accessible(object.attr_handle)
          gtk_accessible = GtkAccessible.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_33(gtk_accessible, gtk_accessible_handle)
          # int
          top_level = ATK.gtk_widget_get_toplevel(gtk_accessible.attr_widget)
          # int
          window = OS._gtk_widget_window(top_level)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_35(x, Array.typed(::Java::Int).new([event.attr_x]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_37(y, Array.typed(::Java::Int).new([event.attr_y]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_39(width, Array.typed(::Java::Int).new([event.attr_width]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_41(height, Array.typed(::Java::Int).new([event.attr_height]), 4)
        return 0
      end
      ...
      def atk_component_get_position(atk_object, x, y, coord_type)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_43(x, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_45(y, Array.typed(::Java::Int).new([0]), 4)
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_COMPONENT_TYPE))
          # int
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_component_get_iface(object.attr_handle))
          component_iface = AtkComponentIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_47(component_iface, super_type)
          if (!(component_iface.attr_get_extents).equal?(0))
        ...
        parent_x = Array.typed(::Java::Int).new(1) { 0 }
        parent_y = Array.typed(::Java::Int).new(1) { 0 }
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_49(parent_x, x, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_51(parent_y, y, 4)
        event = AccessibleControlEvent.new(object.attr_accessible)
        event.attr_child_id = object.attr_id
        event.attr_x = parent_x[0]
        event.attr_y = parent_y[0]
        if ((coord_type).equal?(ATK::ATK_XY_WINDOW))
          ...
          gtk_accessible_handle = ATK._gtk_accessible(object.attr_handle)
          gtk_accessible = GtkAccessible.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_53(gtk_accessible, gtk_accessible_handle)
          # int
          top_level = ATK.gtk_widget_get_toplevel(gtk_accessible.attr_widget)
          # int
          window = OS._gtk_widget_window(top_level)
        ...
        if ((coord_type).equal?(ATK::ATK_XY_WINDOW))
          ...
          gtk_accessible_handle = ATK._gtk_accessible(object.attr_handle)
          gtk_accessible = GtkAccessible.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_55(gtk_accessible, gtk_accessible_handle)
          # int
          top_level = ATK.gtk_widget_get_toplevel(gtk_accessible.attr_widget)
          # int
          window = OS._gtk_widget_window(top_level)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_57(x, Array.typed(::Java::Int).new([event.attr_x]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_59(y, Array.typed(::Java::Int).new([event.attr_y]), 4)
        return 0
      end
      ...
      def atk_component_get_size(atk_object, width, height, coord_type)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_61(width, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_63(height, Array.typed(::Java::Int).new([0]), 4)
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_COMPONENT_TYPE))
          # int
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_component_get_iface(object.attr_handle))
          component_iface = AtkComponentIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_65(component_iface, super_type)
          if (!(component_iface.attr_get_extents).equal?(0))
        ...
        parent_width = Array.typed(::Java::Int).new(1) { 0 }
        parent_height = Array.typed(::Java::Int).new(1) { 0 }
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_67(parent_width, width, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_69(parent_height, height, 4)
        event = AccessibleControlEvent.new(object.attr_accessible)
        event.attr_child_id = object.attr_id
        event.attr_width = parent_width[0]
        event.attr_height = parent_height[0]
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_71(width, Array.typed(::Java::Int).new([event.attr_width]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_73(height, Array.typed(::Java::Int).new([event.attr_height]), 4)
        return 0
      end
      ...
      def atk_component_ref_accessible_at_point(atk_object, x, y, coord_type)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_COMPONENT_TYPE))
          ...
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_component_get_iface(object.attr_handle))
          component_iface = AtkComponentIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_75(component_iface, super_type)
        ...
        if ((coord_type).equal?(ATK::ATK_XY_WINDOW))
          ...
          gtk_accessible_handle = ATK._gtk_accessible(object.attr_handle)
          gtk_accessible = GtkAccessible.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_77(gtk_accessible, gtk_accessible_handle)
          # int
          top_level = ATK.gtk_widget_get_toplevel(gtk_accessible.attr_widget)
          # int
          window = OS._gtk_widget_window(top_level)
      ...
      def atk_object_get_description(atk_object)
        ...
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_79(object_class, super_type)
        ...
        if (!(parent_result).equal?(0))
          length = OS.strlen(parent_result)
          buffer = Array.typed(::Java::Byte).new(length) { 0 }
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_81(buffer, parent_result, length)
          event.attr_result = String.new(Converter.mbcs_to_wcs(nil, buffer))
        end
        i = 0
        while i < listeners.attr_length
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_83(self.attr_description_ptr, name, name.attr_length)
      ...
      def atk_object_get_name(atk_object)
        ...
        super_type = ATK.g_type_class_peek(object.attr_parent_type)
        object_class = AtkObjectClass.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_85(object_class, super_type)
        ...
        if (!(parent_result).equal?(0))
          length = OS.strlen(parent_result)
          buffer = Array.typed(::Java::Byte).new(length) { 0 }
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_87(buffer, parent_result, length)
          event.attr_result = String.new(Converter.mbcs_to_wcs(nil, buffer))
        end
        i = 0
        while i < listeners.attr_length
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_89(self.attr_name_ptr, name, name.attr_length)
      ...
      def atk_object_get_index_in_parent(atk_object)
        ...
        super_type = ATK.g_type_class_peek(object.attr_parent_type)
        object_class = AtkObjectClass.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_93(object_class, super_type)
      ...
      def atk_object_get_parent(atk_object)
        ...
        super_type = ATK.g_type_class_peek(object.attr_parent_type)
        object_class = AtkObjectClass.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_95(object_class, super_type)
      ...
      def atk_object_get_role(atk_object)
        ...
        super_type = ATK.g_type_class_peek(object.attr_parent_type)
        object_class = AtkObjectClass.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_97(object_class, super_type)
      ...
      def atk_object_ref_state_set(atk_object)
        ...
        super_type = ATK.g_type_class_peek(object.attr_parent_type)
        object_class = AtkObjectClass.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_101(object_class, super_type)
      ...
      def atk_selection_is_child_selected(atk_object, index)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_SELECTION_TYPE))
          ...
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_103(selection_iface, super_type)
      ...
      def atk_selection_ref_selection(atk_object, index)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_SELECTION_TYPE))
          ...
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_selection_get_iface(object.attr_handle))
          selection_iface = AtkSelectionIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_105(selection_iface, super_type)
      ...
      def atk_text_get_caret_offset(atk_object)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_TEXT_TYPE))
          ...
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_107(text_iface, super_type)
      ...
      def atk_text_get_character_at_offset(atk_object, offset)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_TEXT_TYPE))
          ...
          super_type = ATK.g_type_class_peek(object.attr_parent_type)
          text_iface = AtkTextIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_109(text_iface, super_type)
      ...
      def atk_text_get_character_count(atk_object)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_TEXT_TYPE))
          ...
          super_type = ATK.g_type_class_peek(object.attr_parent_type)
          text_iface = AtkTextIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_111(text_iface, super_type)
      ...
      def atk_text_get_n_selections(atk_object)
        ...
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_TEXT_TYPE))
          ...
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_text_get_iface(object.attr_handle))
          text_iface = AtkTextIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_113(text_iface, super_type)
      ...
      def atk_text_get_selection(atk_object, selection_num, start_offset, end_offset)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_115(start_offset, Array.typed(::Java::Int).new([0]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_117(end_offset, Array.typed(::Java::Int).new([0]), 4)
        if (ATK.g_type_is_a(object.attr_parent_type, ATK_TEXT_TYPE))
          # int
          super_type = ATK.g_type_interface_peek_parent(ATK._atk_text_get_iface(object.attr_handle))
          text_iface = AtkTextIface.new
          ATK.memmove___org_eclipse_swt_accessibility_accessible_object_119(text_iface, super_type)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_121(parent_start, start_offset, 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_123(parent_end, end_offset, 4)
        ...
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_125(start_offset, Array.typed(::Java::Int).new([event.attr_offset]), 4)
        OS.memmove___org_eclipse_swt_accessibility_accessible_object_127(end_offset, Array.typed(::Java::Int).new([event.attr_offset + event.attr_length]), 4)
        return 0
      end
      ...
      def atk_text_get_text(atk_object, start_offset, end_offset)
        ...
        if (text.length > 0)
          ...
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_129(result, bytes, bytes.attr_length)
          return result
        end
        return 0
      end
      ...
      def atk_text_get_text_after_offset(atk_object, offset_value, boundary_type, start_offset, end_offset)
        ...
        if (text.length > 0)
          ...
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_131(start_offset, Array.typed(::Java::Int).new([start_bounds]), 4)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_133(end_offset, Array.typed(::Java::Int).new([end_bounds]), 4)
          text = RJava.cast_to_string(text.substring(start_bounds, end_bounds))
          bytes = Converter.wcs_to_mbcs(nil, text, true)
          # int
          result = OS.g_malloc(bytes.attr_length)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_135(result, bytes, bytes.attr_length)
          return result
        end
        return 0
      end
      ...
      def atk_text_get_text_at_offset(atk_object, offset_value, boundary_type, start_offset, end_offset)
        ...
        if (text.length > 0)
          ...
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_137(start_offset, Array.typed(::Java::Int).new([start_bounds]), 4)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_139(end_offset, Array.typed(::Java::Int).new([end_bounds]), 4)
          text = RJava.cast_to_string(text.substring(start_bounds, end_bounds))
          bytes = Converter.wcs_to_mbcs(nil, text, true)
          # int
          result = OS.g_malloc(bytes.attr_length)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_141(result, bytes, bytes.attr_length)
          return result
        end
        return 0
      end
      ...
      def atk_text_get_text_before_offset(atk_object, offset_value, boundary_type, start_offset, end_offset)
        ...
        if (text.length > 0)
          ...
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_143(start_offset, Array.typed(::Java::Int).new([start_bounds]), 4)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_145(end_offset, Array.typed(::Java::Int).new([end_bounds]), 4)
          text = RJava.cast_to_string(text.substring(start_bounds, end_bounds))
          bytes = Converter.wcs_to_mbcs(nil, text, true)
          # int
          result = OS.g_malloc(bytes.attr_length)
          OS.memmove___org_eclipse_swt_accessibility_accessible_object_147(result, bytes, bytes.attr_length)
          return result
        end
        return 0
      end
    ...
    def get_text
      ...
      if (ATK.g_type_is_a(@parent_type, ATK_TEXT_TYPE))
        ...
        text_iface = AtkTextIface.new
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_149(text_iface, super_type)
        # int
        character_count = 0
        if (!(text_iface.attr_get_character_count).equal?(0))
        ...
        if (character_count > 0 && !(text_iface.attr_get_text).equal?(0))
          ...
          if (!(parent_result).equal?(0))
            ...
            OS.memmove___org_eclipse_swt_accessibility_accessible_object_151(buffer, parent_result, length_)
    ...
    class_module.module_eval {
      ...
      def g_object_class_finalize(atk_object)
        ...
        ATK.memmove___org_eclipse_swt_accessibility_accessible_object_153(object_class_struct, g_object_class)
