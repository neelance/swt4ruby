...
module Org::Eclipse::Swt::Widgets
  ...
  class Widget 
    ...
    def gtk_key_press_event(widget, event)
      ...
      OS.memmove___org_eclipse_swt_widgets_widget_1(gdk_event, event, GdkEventKey.attr_sizeof)
    ...
    def gtk_key_release_event(widget, event)
      gdk_event = GdkEventKey.new
      OS.memmove___org_eclipse_swt_widgets_widget_3(gdk_event, event, GdkEventKey.attr_sizeof)
