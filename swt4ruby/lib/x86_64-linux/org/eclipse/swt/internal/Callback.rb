...
module Org::Eclipse::Swt::Internal
  ...
  class Callback 
    ...
    typesig { [Object, String, ::Java::Int, ::Java::Boolean, ::Java::Long] }
    # Constructs a new instance of this class given an object
    # to send the message to, a string naming the method to
    ...
    class_module.module_eval {
      JNI.native_method :Java_org_eclipse_swt_internal_Callback_bind, [:pointer, :long, :long, :long, :long, :long, :int32, :int8, :int8, :int64], :int64
      typesig { [Callback, Object, String, String, ::Java::Int, ::Java::Boolean, ::Java::Boolean, ::Java::Long] }
