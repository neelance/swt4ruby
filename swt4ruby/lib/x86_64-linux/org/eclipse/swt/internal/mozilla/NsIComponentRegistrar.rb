...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIComponentRegistrarImports
  ...
  class NsIComponentRegistrar < NsISupports
    ...
    typesig { [NsID, Array.typed(::Java::Byte), Array.typed(::Java::Byte), ::Java::Long] }
    # int
    ...
    typesig { [NsID, Array.typed(::Java::Byte), Array.typed(::Java::Byte), ::Java::Long, Array.typed(::Java::Byte), Array.typed(::Java::Byte)] }
    # int
