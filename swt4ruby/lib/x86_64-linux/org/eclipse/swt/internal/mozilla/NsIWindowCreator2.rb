...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIWindowCreator2Imports
  ...
  class NsIWindowCreator2 < NsIWindowCreator
    ...
    typesig { [::Java::Long, ::Java::Int, ::Java::Int, ::Java::Long, Array.typed(::Java::Int), Array.typed(::Java::Long)] }
    # int
    # int
    # int
