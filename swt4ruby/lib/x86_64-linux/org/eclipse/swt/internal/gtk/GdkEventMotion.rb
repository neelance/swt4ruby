...
module Org::Eclipse::Swt::Internal::Gtk
  module GdkEventMotionImports #:nodoc:
  ...
  class GdkEventMotion < GdkEventMotionImports.const_get :GdkEvent
    include_class_members GdkEventMotionImports
    ...
    # @field cast=(gint16)
    attr_accessor :is_hint
    alias_method :attr_is_hint, :is_hint
    undef_method :is_hint
    alias_method :attr_is_hint=, :is_hint=
    undef_method :is_hint=
    ...
    class_module.module_eval {
      const_set_lazy(:Sizeof) { OS._gdk_event_motion_sizeof }
    ...
    private
    alias_method :initialize__gdk_event_motion, :initialize
  end
