  ...
  class Mozilla < MozillaImports.const_get :WebBrowser
      ...
      when_class_loaded do
        MozillaClearSessions = Class.new(Runnable.class == Class ? Runnable : Object) do
          ...
          define_method :run do
            ...
            service_manager = NsIServiceManager::self.class.new(result[0])
            result[0] = 0
            ...
            manager = NsICookieManager::self.class.new(result[0])
            result[0] = 0
            ...
            manager._release
            enumerator = NsISimpleEnumerator::self.class.new(result[0])
            ...
            while (!(more_elements[0]).equal?(0))
              ...
              cookie = NsICookie::self.class.new(result[0])
    ...
    def create(parent, style)
      ...
      if (!self.attr_initialized)
        ...
        if (init_loaded)
          ...
          C.memmove(lower, bytes, bytes.attr_length)
          ...
          C.memmove(upper, bytes, bytes.attr_length)
      ...
      if ((display.get_data(DISPOSE_LISTENER_HOOKED)).nil?)
        ...
        display.add_listener(SWT::Dispose, Class.new(Listener.class == Class ? Listener : Object) do
          ...
          define_method :handle_event do |event|
            ...
            service_manager = NsIServiceManager::self.class.new(result_[0])
            result_[0] = 0
            buffer = MozillaDelegate.wcs_to_mbcs(nil, XPCOM::NS_OBSERVER_CONTRACTID, true)
            ...
            observer_service = NsIObserverService::self.class.new(result_[0])
            result_[0] = 0
            ...
            if (!(self.attr_location_provider).nil?)
              ...
              path_string = NsEmbedString::self.class.new(prefs_location)
              ...
              path_string.dispose
              local_file = NsILocalFile::self.class.new(result_[0])
              result_[0] = 0
              ...
              local_file._release
              pref_file = NsIFile::self.class.new(result_[0])
              result_[0] = 0
              ...
              pref_service = NsIPrefService::self.class.new(result_[0])
              result_[0] = 0
    ...
    def get_text
      ...
      if ((rc).equal?(XPCOM::NS_OK))
        ...
        XPCOM.memmove(chars, buffer, length_ * 2)
        ...
        length_ = XPCOM.strlen__prunichar(result[0])
        chars = CharArray.new(length_)
        XPCOM.memmove(chars, result[0], length_ * 2)
      end
      component_manager._release
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsIWeakReference::NS_IWEAKREFERENCE_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@weak_reference.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      ...
      if (guid._equals(NsIWebBrowserChrome::NS_IWEBBROWSERCHROME_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@web_browser_chrome.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIWebBrowserChromeFocus::NS_IWEBBROWSERCHROMEFOCUS_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@web_browser_chrome_focus.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIEmbeddingSiteWindow::NS_IEMBEDDINGSITEWINDOW_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@embedding_site_window.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIInterfaceRequestor::NS_IINTERFACEREQUESTOR_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@interface_requestor.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsISupportsWeakReference::NS_ISUPPORTSWEAKREFERENCE_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@supports_weak_reference.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIContextMenuListener::NS_ICONTEXTMENULISTENER_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@context_menu_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsIURIContentListener::NS_IURICONTENTLISTENER_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@uri_content_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsITooltipListener::NS_ITOOLTIPLISTENER_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@tooltip_listener.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
    ...
    def _get_interface(riid, ppv_object)
      ...
      if (guid._equals(NsIDOMWindow::NS_IDOMWINDOW_IID))
        ...
        XPCOM.memmove(ppv_object, a_content_domwindow, C::PTR_SIZEOF)
        return rc
      end
      return _query_interface(riid, ppv_object)
    end
    ...
    def _on_status_change(a_web_progress, a_request, a_status, a_message)
      ...
      dest = CharArray.new(length_)
      XPCOM.memmove(dest, a_message, length_ * 2)
    ...
    def _set_status(status_type, status)
      ...
      dest = CharArray.new(length_)
      XPCOM.memmove(dest, status, length_ * 2)
    ...
    def _get_web_browser(a_web_browser)
      ...
      XPCOM.memmove(a_web_browser, ret, C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    def _get_chrome_flags(a_chrome_flags)
      ...
      ret[0] = @chrome_flags
      XPCOM.memmove(a_chrome_flags, ret, 4)
      # PRUint32
      return XPCOM::NS_OK
    end
    ...
    def _is_window_modal(retval)
      ...
      XPCOM.memmove(retval, Array.typed(::Java::Int).new([result]), 4)
      # PRBool
      return XPCOM::NS_OK
    end
    ...
    def _get_dimensions(flags, x, y, cx, cy)
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_POSITION)).equal?(0))
        ...
        if (!(x).equal?(0))
          C.memmove(x, Array.typed(::Java::Int).new([location.attr_x]), 4)
        end
        # PRInt32
        if (!(y).equal?(0))
          C.memmove(y, Array.typed(::Java::Int).new([location.attr_y]), 4)
        end
        # PRInt32
      end
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_SIZE_INNER)).equal?(0))
        ...
        if (!(cx).equal?(0))
          C.memmove(cx, Array.typed(::Java::Int).new([size.attr_x]), 4)
        end
        # PRInt32
        if (!(cy).equal?(0))
          C.memmove(cy, Array.typed(::Java::Int).new([size.attr_y]), 4)
        end
        # PRInt32
      end
      if (!((flags & NsIEmbeddingSiteWindow::DIM_FLAGS_SIZE_OUTER)).equal?(0))
    ...
    def _get_visibility(a_visibility)
      ...
      XPCOM.memmove(a_visibility, Array.typed(::Java::Int).new([visible ? 1 : 0]), 4)
      # PRBool
      return XPCOM::NS_OK
    end
    ...
    def _set_title(a_title)
      ...
      if (length_ > 0)
        dest = CharArray.new(length_)
        XPCOM.memmove(dest, a_title, length_ * 2)
    ...
    def _get_site_window(a_site_window)
      ...
      # 
      # int
      XPCOM.memmove(a_site_window, Array.typed(::Java::Long).new([@embed_handle]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    def _is_preferred(a_content_type, a_desired_content_type, retval)
      ...
      if (size > 0)
        ...
        XPCOM.memmove(type_bytes, a_content_type, size)
      ...
      XPCOM.memmove(retval, Array.typed(::Java::Int).new([preferred ? 1 : 0]), 4)
      # PRBool
      if (preferred)
        # int
        XPCOM.memmove(a_desired_content_type, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      end
      return XPCOM::NS_OK
    end
