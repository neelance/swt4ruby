...
module Org::Eclipse::Swt::Browser
  ...
  class PromptService2 
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long] }
    # int
    # int
    # int
    # int
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long] }
    # int
    # int
    # int
    # int
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Long, ::Java::Long, ::Java::Long] }
    # int
    # int
    # int
    # int
    ...
    def _prompt_auth(a_parent, a_channel, level, auth_info, checkbox_label, checkbox_value, _retval)
      ...
      # int
      # int
      uri = Array.typed(::Java::Long).new(1) { 0 }
    ...
    typesig { [::Java::Long, ::Java::Long, ::Java::Long, ::Java::Int, ::Java::Long, ::Java::Long, ::Java::Long] }
    # int
    # int
    # int
    # int
