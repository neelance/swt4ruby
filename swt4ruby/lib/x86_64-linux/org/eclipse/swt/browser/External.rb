  ...
  class External 
    ...
    def _query_interface(riid, ppv_object)
      ...
      if (guid._equals(NsIClassInfo::NS_ICLASSINFO_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@class_info.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(NsISecurityCheckedComponent::NS_ISECURITYCHECKEDCOMPONENT_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@security_checked_component.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      if (guid._equals(EXTERNAL_IID))
        # int
        XPCOM.memmove(ppv_object, Array.typed(::Java::Long).new([@external.get_address]), C::PTR_SIZEOF)
        _add_ref
        return XPCOM::NS_OK
      end
      # int
    ...
    def get_class_description(_ret_value)
      ...
      # int
      C.memmove(_ret_value, Array.typed(::Java::Long).new([ptr]), C::PTR_SIZEOF)
      memory._release
      return XPCOM::NS_OK
    end
    ...
    def get_helper_for_language(language, _ret_value)
      # int
      C.memmove(_ret_value, Array.typed(::Java::Long).new([0]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
    ...
    def get_interfaces(count, array)
      ...
      # int
      C.memmove(ptr_array, Array.typed(::Java::Long).new([security_checked_component_iid]), C::PTR_SIZEOF)
      # int
      C.memmove(ptr_array + C::PTR_SIZEOF, Array.typed(::Java::Long).new([external_iid]), C::PTR_SIZEOF)
      # int
      C.memmove(array, Array.typed(::Java::Long).new([ptr_array]), C::PTR_SIZEOF)
      memory._release
    ...
    def can_create_wrapper(iid, _ret_val)
      ...
      C.memmove(ptr, bytes, bytes.attr_length)
      # int
      C.memmove(_ret_val, Array.typed(::Java::Long).new([ptr]), C::PTR_SIZEOF)
      memory._release
      return XPCOM::NS_OK
    end
        ...
        if (length_ > 0)
          ...
          while i < length_
            ...
            begin
              ...
              # int
              C.memmove(array_ptr + C::PTR_SIZEOF * i, Array.typed(::Java::Long).new([current_variant.get_address]), C::PTR_SIZEOF)
    ...
    def call_java(function_id, args, return_ptr)
      ...
      # int
      C.memmove(return_ptr, Array.typed(::Java::Long).new([variant.get_address]), C::PTR_SIZEOF)
      return XPCOM::NS_OK
    end
