...
module Org::Eclipse::Swt::Accessibility
  module AccessibleControlAdapterImports #:nodoc:
  ...
  class AccessibleControlAdapter 
    include_class_members AccessibleControlAdapterImports
    include AccessibleControlListener
    ...
    private
    alias_method :initialize__accessible_control_adapter, :initialize
  end
