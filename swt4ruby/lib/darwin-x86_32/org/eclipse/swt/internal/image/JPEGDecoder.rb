...
module Org::Eclipse::Swt::Internal::Image
  module JPEGDecoderImports #:nodoc:
  ...
  class JPEGDecoder 
    ...
    class_module.module_eval {
      ...
      const_set_lazy(:Jpeg_d_coef_controller) { Class.new do
        ...
        typesig { [class_self::Jpeg_decompress_struct] }
      ...
      const_set_lazy(:Jpeg_entropy_decoder) { Class.new do
        ...
        typesig { [class_self::Jpeg_decompress_struct, Array.typed(Array.typed(::Java::Short))] }
        ...
        def initialize
          ...
          @br_state_local = self.class::Bitread_working_state.new
          @state_local = self.class::Savable_state.new
        end
      ...
      const_set_lazy(:Huff_entropy_decoder) { Class.new(Jpeg_entropy_decoder) do
        ...
        def start_pass_huff_decoder(cinfo)
          ...
          while ci < cinfo.attr_comps_in_scan
            ...
            jpeg_make_d_derived_tbl(cinfo, true, dctbl, entropy.attr_dc_derived_tbls[dctbl] = self.class::D_derived_tbl.new)
            jpeg_make_d_derived_tbl(cinfo, false, actbl, entropy.attr_ac_derived_tbls[actbl] = self.class::D_derived_tbl.new)
        ...
        def initialize
          ...
          @ac_needed = nil
          super()
          @bitstate = self.class::Bitread_perm_state.new
          @saved = self.class::Savable_state.new
          @dc_derived_tbls = Array.typed(self.class::D_derived_tbl).new(NUM_HUFF_TBLS) { nil }
          @ac_derived_tbls = Array.typed(self.class::D_derived_tbl).new(NUM_HUFF_TBLS) { nil }
          @dc_cur_tbls = Array.typed(self.class::D_derived_tbl).new(D_MAX_BLOCKS_IN_MCU) { nil }
          @ac_cur_tbls = Array.typed(self.class::D_derived_tbl).new(D_MAX_BLOCKS_IN_MCU) { nil }
      ...
      const_set_lazy(:Phuff_entropy_decoder) { Class.new(Jpeg_entropy_decoder) do
          ...
          while ci < cinfo.attr_comps_in_scan
            ...
            if (is_dc_band)
              if ((cinfo.attr_ah).equal?(0))
                ...
                jpeg_make_d_derived_tbl(cinfo, true, tbl, entropy.attr_derived_tbls[tbl] = self.class::D_derived_tbl.new)
              end
            else
              tbl = compptr.attr_ac_tbl_no
              jpeg_make_d_derived_tbl(cinfo, false, tbl, entropy.attr_derived_tbls[tbl] = self.class::D_derived_tbl.new)
        ...
        def initialize
          ...
          @bitstate = self.class::Bitread_perm_state.new
          @saved = self.class::Savable_state.new
          @derived_tbls = Array.typed(self.class::D_derived_tbl).new(NUM_HUFF_TBLS) { nil }
      ...
      const_set_lazy(:Jpeg_color_quantizer) { Class.new do
        ...
        typesig { [class_self::Jpeg_decompress_struct, ::Java::Boolean] }
      ...
      const_set_lazy(:Jpeg_d_main_controller) { Class.new do
        ...
        typesig { [class_self::Jpeg_decompress_struct, ::Java::Int] }
      ...
      const_set_lazy(:Jpeg_decompress_struct) { Class.new do
        ...
        def initialize
          ...
          @output_i_mcu_row = 0
          @coef_bits = nil
          @quant_tbl_ptrs = Array.typed(self.class::JQUANT_TBL).new(NUM_QUANT_TBLS) { nil }
          @dc_huff_tbl_ptrs = Array.typed(self.class::JHUFF_TBL).new(NUM_HUFF_TBLS) { nil }
          @ac_huff_tbl_ptrs = Array.typed(self.class::JHUFF_TBL).new(NUM_HUFF_TBLS) { nil }
          @data_precision = 0
          @comp_info = nil
          ...
          @comps_in_scan = 0
          @cur_comp_info = Array.typed(self.class::Jpeg_component_info).new(MAX_COMPS_IN_SCAN) { nil }
          @mcus_per_row = 0
          @mcu_rows_in_scan = 0
          @blocks_in_mcu = 0
