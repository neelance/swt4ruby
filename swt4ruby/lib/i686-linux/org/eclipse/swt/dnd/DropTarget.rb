...
module Org::Eclipse::Swt::Dnd
  ...
  class DropTarget < DropTargetImports.const_get :Widget
    ...
    def drag_motion(widget, context, x, y, time)
      ...
      if ((old_key_operation).equal?(-1))
        @drag_over_heartbeat.run___org_eclipse_swt_dnd_drop_target_3
      end
      return true
    end
    ...
    def set_transfer(transfer_agents)
      ...
      while i < transfer_agents.attr_length
        ...
        if (!(transfer).nil?)
          ...
          while j < type_ids.attr_length
            ...
            OS.memmove___org_eclipse_swt_dnd_drop_target_5(entry.attr_target, buffer, buffer.attr_length)
      ...
      while i_ < targets.attr_length
        OS.memmove___org_eclipse_swt_dnd_drop_target_7(p_targets + i_ * GtkTargetEntry.attr_sizeof, targets[i_], GtkTargetEntry.attr_sizeof)
        i_ += 1
      end
    ...
    typesig { [::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, DNDEvent] }
    # long
    def set_event_data(context, x, y, time, event)
      ...
      OS.memmove___org_eclipse_swt_dnd_drop_target_9(drag_context, context, GdkDragContext.attr_sizeof)
      ...
      while i < length
        ...
        OS.memmove___org_eclipse_swt_dnd_drop_target_11(gtk_target_pair, p_data, GtkTargetPair.attr_sizeof)
