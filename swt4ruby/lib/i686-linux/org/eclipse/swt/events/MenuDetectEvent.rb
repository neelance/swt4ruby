...
module Org::Eclipse::Swt::Events
  module MenuDetectEventImports #:nodoc:
  ...
  class MenuDetectEvent < MenuDetectEventImports.const_get :TypedEvent
    ...
    def to_s
      string = super
      # remove trailing '}'
      return RJava.cast_to_string(string.substring(0, string.length - 1)) + " x=" + RJava.cast_to_string(@x) + " y=" + RJava.cast_to_string(@y) + " doit=" + RJava.cast_to_string(@doit) + "}"
    end
