...
module Org::Eclipse::Swt::Graphics
  ...
  class SwtGC < GCImports.const_get :Resource
    ...
    class_module.module_eval {
      typesig { [::Java::Int, String, ::Java::Float, ::Java::Float, Font] }
      # long
    ...
    def convert_rgn(rgn, matrix)
      ...
      # long
      # long
      rects = Array.typed(::Java::Int).new(1) { 0 }
          ...
          if (!(pixbuf).equal?(0))
            ...
            if (!(mask_pixbuf).equal?(0))
              ...
              if (!(scaled_pixbuf).equal?(0))
                # long
                # long
                color_buffer = Array.typed(::Java::Int).new(1) { 0 }
                # long
                # long
                mask_buffer = Array.typed(::Java::Int).new(1) { 0 }
    ...
    typesig { [Image, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Boolean, ::Java::Int, ::Java::Int, ::Java::Int, ::Java::Int] }
    # long
    ...
    typesig { [::Java::Int, Array.typed(::Java::Int), ::Java::Boolean] }
    # long
    ...
    class_module.module_eval {
      ...
      typesig { [::Java::Int, ::Java::Int, Color, ::Java::Int] }
      # long
