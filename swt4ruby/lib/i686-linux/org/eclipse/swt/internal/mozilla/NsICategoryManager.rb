...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsICategoryManagerImports
  ...
  class NsICategoryManager < NsISupports
    ...
    typesig { [Array.typed(::Java::Byte), Array.typed(::Java::Byte), Array.typed(::Java::Int)] }
    # long
    ...
    typesig { [Array.typed(::Java::Byte), Array.typed(::Java::Byte), Array.typed(::Java::Byte), ::Java::Int, ::Java::Int, Array.typed(::Java::Int)] }
    # long
