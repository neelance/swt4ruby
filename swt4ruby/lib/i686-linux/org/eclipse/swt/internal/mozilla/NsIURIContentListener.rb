...
module Org::Eclipse::Swt::Internal::Mozilla
  module NsIURIContentListenerImports
  ...
  class NsIURIContentListener < NsISupports
    ...
    typesig { [Array.typed(::Java::Byte), ::Java::Int, ::Java::Int, Array.typed(::Java::Int), Array.typed(::Java::Int)] }
    # long
    # long
    ...
    typesig { [Array.typed(::Java::Byte), ::Java::Int, Array.typed(::Java::Int), Array.typed(::Java::Int)] }
    # long
