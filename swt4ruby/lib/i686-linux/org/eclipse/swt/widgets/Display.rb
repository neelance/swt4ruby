...
module Org::Eclipse::Swt::Widgets
  ...
  class Display < DisplayImports.const_get :Device
    ...
    def initialize(data)
      ...
      # long
      @flush_data = Array.typed(::Java::Int).new(1) { 0 }
    ...
    def add_gdk_event(event)
      if ((@gdk_events).nil?)
        length = GROW_SIZE
        # long
        @gdk_events = Array.typed(::Java::Int).new(length) { 0 }
      ...
      if ((@gdk_event_count).equal?(@gdk_events.attr_length))
        ...
        # long
        # long
        new_events = Array.typed(::Java::Int).new(length) { 0 }
    ...
    def get_cursor_control
      ...
      if (!(window).equal?(0))
        ...
        # long
        # long
        unused_ptr = Array.typed(::Java::Int).new(1) { 0 }
        # long
        buffer = Array.typed(::Java::Int).new(1) { 0 }
        # long
        x_window = 0
    ...
    def get_work_area
      ...
      # long
      # long
      actual_type = Array.typed(::Java::Int).new(1) { 0 }
    ...
    def initialize_callbacks
      # long
      @closures = Array.typed(::Java::Int).new(Widget::LAST_SIGNAL) { 0 }
