...
module Org::Eclipse::Swt::Widgets
  ...
  class IME < IMEImports.const_get :Widget
    ...
    def gtk_preedit_changed(imcontext)
      ...
      # long
      # long
      pango_attrs = Array.typed(::Java::Int).new(1) { 0 }
      ...
      if (!(preedit_string[0]).equal?(0))
        ...
        OS.memmove___org_eclipse_swt_widgets_ime_5(buffer, preedit_string[0], length_)
        chars = Converter.mbcs_to_wcs(nil, buffer)
        if (!(pango_attrs[0]).equal?(0))
          ...
          while i < count
            ...
            if (!(attr).equal?(0))
              OS.memmove___org_eclipse_swt_widgets_ime_9(attr_color, attr, PangoAttrColor.attr_sizeof)
              color = GdkColor.new
              color.attr_red = attr_color.attr_color_red
              color.attr_green = attr_color.attr_color_green
              color.attr_blue = attr_color.attr_color_blue
            ...
            if (!(attr).equal?(0))
              OS.memmove___org_eclipse_swt_widgets_ime_11(attr_int, attr, PangoAttrInt.attr_sizeof)
              ...
              if (@styles[i].attr_underline)
                ...
                if (!(attr).equal?(0))
                  OS.memmove___org_eclipse_swt_widgets_ime_13(attr_color, attr, PangoAttrColor.attr_sizeof)
                  color = GdkColor.new
                  color.attr_red = attr_color.attr_color_red
                  color.attr_green = attr_color.attr_color_green
                  color.attr_blue = attr_color.attr_color_blue
